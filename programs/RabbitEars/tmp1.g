...
WJDrabbitDemo:=function()
    local G;
    
    G:=TransitiveGroup(12,7);
    Print("\n The congruences of the transitive group C2 x A4 are:\n");
    ...
    # Pick a1, ..., ak, b1, ..., bk, say, a=[1, 1], b=[6, 7]
    # and run the WJDrabbit function:
    WJDrabbit([G, [1, 1], [6, 7]]);
    # This produces a file called WJDrabbit-C2 x A4.ua.
end;
